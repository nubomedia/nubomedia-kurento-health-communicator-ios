Pod::Spec.new do |s|
  ...
  s.subspec 'Default' do |ss|
    ...
    ss.dependency 'KurentoToolboxMod/WebRTC'
    ss.dependency 'KurentoToolboxMod/JSON-RPC'
    ss.dependency 'KurentoToolboxMod/Room'
    ss.dependency 'KurentoToolboxMod/Tree'
  ...
  s.subspec 'WebRTC' do |ss|
    ...
    ss.dependency 'KurentoToolboxMod/Utils'
  end
