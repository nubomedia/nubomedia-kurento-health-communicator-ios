...
NUBOMEDIA Kurento Health Communicator is a messaging client with multiconference capabilities. This iOS app allows you to create and manage groups, send messages to an unique person or a group, and create multiconferences between all the members of a group.

Multiconference feature has been developed to check the [NUBOMEDIA Kurento Toolbox] for iOS.
...
[NUBOMEDIA Kurento Toolbox]:https://github.com/nubomediaTI/Kurento-iOS
